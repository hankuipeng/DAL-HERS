...
cdef extern from "boruvka_superpixel.h":
    cdef cppclass BoruvkaSuperpixel:
        ...
        int n_edgeless()
        # build_2d
        void build_2d(int, int, int, np.uint8_t*, np.uint8_t*,    np.uint8_t*   , 
                np.int8_t *, np.int32_t*)
        void build_2d(int, int, int, np.uint16_t *, np.uint16_t *,  np.uint16_t * ,
                np.int8_t *, np.int32_t *)
        void build_2d(int, int, int, np.int8_t *, np.int8_t *,    np.int8_t *   , 
                np.int8_t *, np.int32_t *)
        void build_2d(int, int, int, np.int16_t *, np.int16_t *,   np.int16_t *  ,
                np.int8_t *, np.int32_t *)
        void build_2d(int, int, int, np.int32_t *, np.int32_t *,   np.int32_t *  ,
                np.int8_t *, np.int32_t *)
        void build_2d(int, int, int, np.float32_t *, np.float32_t *, np.float32_t *, 
                np.int8_t *, np.int32_t *)
        void build_2d(int, int, int, np.float64_t *, np.float64_t *, np.float64_t *, 
                np.int8_t *, np.int32_t *)
        # build_3d
