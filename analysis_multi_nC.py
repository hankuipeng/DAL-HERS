...
def main():
    ...
    for n in range(len(tst_lst)):
        ...
        ## segmentation given various numbers of superpixels
        nC_seq = [v for v in range(200, 1201, 200)]
        ...
        for nC in nC_seq:
            ...
            save_csv_path = args.output_dir + str(nC) + '/csv/'
            ...
            save_png_path = args.output_dir + str(nC) + '/png/'
            ...
            print("Just finished the {0}th image for nC={1}, with HERS run time of {2:.2f} ms".format(int(n), nC, elapsed_time))
